...
- `GLOSSARY.md`: The canonical language for this workspace — the agreed term for each concept, which all lessons, reference docs, and learning records should adhere to. Use the format in [GLOSSARY-FORMAT.md](./GLOSSARY-FORMAT.md).
...
Glossaries, in particular, are an essential reference. Maintain the glossary in `GLOSSARY.md` using the format in [GLOSSARY-FORMAT.md](./GLOSSARY-FORMAT.md). Once a term is in the glossary, it should be adhered to in every lesson.
