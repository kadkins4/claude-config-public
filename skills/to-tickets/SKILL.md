---
name: to-tickets
description: Break a plan, spec, or the current conversation into a set of tracer-bullet tickets, each declaring its blocking edges, written as one local markdown file per ticket in the repo.
...
There is no issue tracker and no triage-label vocabulary: tickets live as local markdown files in the repo (see step 5).
